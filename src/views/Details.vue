    ...
    <div class="main">
      ...
      <div class="block">
        <el-carousel height="560px" v-if="productPicture.length>1">
          <el-carousel-item v-for="item in productPicture" :key="item.id">
            <img style="height:560px;width: 560px;" :src="$target + item.product_picture" :alt="item.intro" />
          </el-carousel-item>
        </el-carousel>
      ...
      <div class="content">
        ...
        <div class="pro-policy">
          <ul>
            <li>
              <i class="el-icon-circle-check"></i> 猫猫自营
            </li>
            <li>
              <i class="el-icon-circle-check"></i> 猫猫发货
            </li>
            <li>
